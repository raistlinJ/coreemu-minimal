...
apt-get install -y sudo curl wget jq git vim nano htop build-essential ca-certificates software-properties-common tcpdump tshark python3-dev python3-venv python3-pip python3.9-venv python3-tk libtool gawk libreadline-dev automake pkg-config libxml2-dev libxslt1-dev zlib1g-dev libjpeg-dev libev-dev

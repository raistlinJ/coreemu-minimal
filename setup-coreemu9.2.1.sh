...
apt-get install -y sudo curl wget jq git vim nano htop build-essential ca-certificates software-properties-common tcpdump tshark python3-full python3-venv python3-pip python3.11-venv python3-tk libtool gawk libreadline-dev automake pkg-config
